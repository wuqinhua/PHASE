...
gene_list_df = pd.read_csv(r"./Info/Age_hvg_genes.csv") 
...
for i, data in enumerate(allLoader, 0):
    ...
    ig_attr_test = ig.attribute(inputs=inputs[0],n_steps=10)
...
df_fea.to_csv(r"./Analysis_result/Attr_result/attr_age_all.csv")
print('IG Finished!')
